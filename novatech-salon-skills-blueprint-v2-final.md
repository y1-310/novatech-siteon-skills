...
事業用：siteon.officialsupport@gmail.com
...
```
問い合わせメール着信（siteon.officialsupport@gmail.com）
  ↓
...
Claude Code が /gws-gmail で送信
  送信元：siteon.officialsupport@gmail.com
```
...
Formspreeが処理
  ↓
2箇所に通知：
  ① siteon.officialsupport@gmail.com → Agent が検知・対応
