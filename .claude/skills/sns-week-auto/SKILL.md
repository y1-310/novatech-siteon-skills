...
## Step 4: 画像生成（Codex CLI）

**担当:** 制作・品質部長 → Codex CLI  
**参照:** Step 3のP1〜P4テキスト + パターン別デザイン仕様  
...
**パターンA（ナチュラル）**
- 背景: #F5F0E8（クリーム）
- アクセント: #7B9E7B（セージグリーン）
- フォント: Zen Kaku Gothic / Noto Sans JP
- P1: フック数字（大）+ サブタイトル
- P2〜P3: リスト形式（✓ マーク付き）
- P4: CTA＋価格帯
...
- テキスト: #1A1A1A
- アクセント: #1B3A6B（ネイビー）
- レイアウト: 2カラム、写真＋テキスト並列

Codex CLI実行例:
```bash
codex "sns/plans/YYYY-WNN-plan.json のW19-01の画像（パターンA）を
sns/images/2026-W19/W19-01/ にP1.png〜P4.pngとして生成してください"
```
