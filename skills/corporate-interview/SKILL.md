...
| # | 質問 | 形式 | 選択肢 |
|---|------|------|--------|
| Q13 | 士業別カラー（corporate判定時） | single_select | 税理士 / 行政書士 / 社労士 / 弁護士 / コンサル・一般法人 / おまかせ |
| Q14 | ※corporate判定時はQ13に統合して非表示 | — | — |
...
| # | 質問 | 形式 | 選択肢 |
|---|------|------|--------|
| Q18 | 追加セクション | multi_select | ヒーロー直下CTA / 代表者プロフィール / 解決事例 / Google口コミ / 料金表 / 実績・事例 / ブログ・コラム / FAQ / サービスの流れ / お客様の声 / 提携先 / お知らせ / 採用 / メディア掲載 / 特になし |
