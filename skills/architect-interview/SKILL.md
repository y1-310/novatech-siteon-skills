...
| # | 質問 | 形式 | 選択肢 |
|---|------|------|--------|
| Q13 | カラー方向性 | single_select | ホワイト×ナチュラル / ウォーム×木目 / ミニマル×モノトーン / おまかせ |
| Q14 | 全体のトーン | single_select | 静謐・上品 / 温もり・親しみ / 理知的・洗練 / おまかせ |
...
| # | 質問 | 形式 | 選択肢 |
|---|------|------|--------|
| Q18 | 追加セクション | multi_select | 設計料目安 / ブログ・コラム / 受賞歴 / 商品ライン / 性能数値 / イベント / モデルルーム / ビフォーアフター / 費用ガイド / 採用 / 特になし |
